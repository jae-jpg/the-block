    ...
    >
      <Container>
        <Text>
          ...
          The Block measures the <Em>semantic similarity</Em> between location data and the criteria that you provide in order to determine the best matches.
          Created using <Em>API integration</Em> with <a href="https://www.mediawiki.org/wiki/API:Main_page">Wikipedia</a> and <a href="http://www.cortical.io/">Cortical.io</a> APIs.
        </Text>
